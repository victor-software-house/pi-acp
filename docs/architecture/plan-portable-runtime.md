...
| 11 — Diagnostics + release | `buildDiagnosticsReport` + first-prompt emission + manifest-level diagnostic flow-through | All prior | S (shipped — `v0.13.0` marks substrate complete) |
